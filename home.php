...
if(!isset($_SESSION['id'])){
    header("Location:./index.html?heyyy");
}
?>
...
<!-- Mirrored from themified.com/friend-finder/newsfeed-people-nearby.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Sep 2021 16:41:03 GMT -->
<head>
    ...
    <div id="page-contents">
    	<div class="container">
          ...
          ================================================= -->
            ...
            <li><i class="icon ion-ios-people"></i><div><a href="#">Home page</a></div></li>
            <li><i class="icon ion-ios-paper"></i><div><a href="friends.php">Friends</a></div></li>
            ...
            <!-- Nearby People List
            ================================================= -->
            <div id="content" class="people-nearby">
...
<!-- Mirrored from themified.com/friend-finder/newsfeed-people-nearby.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Sep 2021 16:41:06 GMT -->
</html>
